  ...
  <div id="app" class="min-h-screen bg-gray-200 antialiased xl:flex xl:flex-col xl:h-screen">
    ...
    <div class="xl:flex-1 xl:flex xl:overflow-y-hidden">
      ...
      <main class="py-6 xl:flex-1 xl:overflow-x-hidden">
        <div v-for="(location, il) in locations" :class="{'mt-6': il > 0}" :key="il">
          ...
          <div class="mt-6 sm:overflow-x-auto sm:overflow-y-hidden">
            <div class="px-4 sm:inline-flex sm:pt-2 sm:pb-8 xl:px-8">
              <div v-for="(property, ip) in location.properties" :class="{'mt-10 sm:ml-4': ip > 0 }" class="sm:mt-0 sm:w-80 sm:flex-shrink-0" :key="ip">
...
<script>
  export default {
    components: {
      ...
      PropertyCard: () => import('@/components/PropertyCard')
    },
    data () {
      return {
        locations: [
